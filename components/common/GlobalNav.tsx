  ...
  return (
    <nav className="fixed bottom-0 w-full left-0">
      <ul className="flex">
        ...
        <li className="flex flex-col gap-1 items-center justify-center flex-1 pt-2 pb-1 border-t border-r border-neutral-200 bg-white text-sm"><FaVenusMars className="text-2xl" />産卵管理</li>
